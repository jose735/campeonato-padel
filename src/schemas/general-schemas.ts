...
export type CreateJourneyParticipantFormData = z.infer<
  typeof createJourneyParticipantSchema
>;
...
export type CreateJourneyMatchFormData = z.infer<
  typeof createJourneyMatchSchema
>;
